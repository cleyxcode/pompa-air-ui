              ...
              {showUserInfo && (
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex flex-col items-start gap-1.5" style={{ color: 'white' }}>
                  ...
                  <button
                    ...
                    style={{ pointerEvents: 'auto', display: 'block', gridArea: 'auto', borderRadius: '8px', color: 'white', background: 'rgba(0,0,0,0.2)' }}
                    type="button"
